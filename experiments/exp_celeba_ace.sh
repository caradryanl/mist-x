...
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1135/lora_weight.safetensors -op outputs/celeba/ace_t2i/1135 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1422/lora_weight.safetensors -op outputs/celeba/ace_t2i/1422 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1499/lora_weight.safetensors -op outputs/celeba/ace_t2i/1499 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1657/lora_weight.safetensors -op outputs/celeba/ace_t2i/1657 -spi 100 -p "a photo of a sks person"
...
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1135 -op outputs/celeba/ace_i2i/1135 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1422 -op outputs/celeba/ace_i2i/1422 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1499 -op outputs/celeba/ace_i2i/1499 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1657 -op outputs/celeba/ace_i2i/1657 -spi 1 -p "a photo of a sks person"
