...
accelerate launch attacks/ace_sd3.py \
    ...
    --class_data_dir data/class/wikiart/ace \
...
python scripts/run_inference.py -m t2i -lp models/loras/wikiart/ace/Fauvism_henri-matisse/lora_weight.safetensors -op outputs/wikiart/ace_t2i/Fauvism_henri-matisse -spi 100 -p "a photo of a sks painting"
python scripts/run_inference.py -m t2i -lp models/loras/wikiart/ace/Impressionism_claude-monet/lora_weight.safetensors -op outputs/wikiart/ace_t2i/Impressionism_claude-monet -spi 100 -p "a photo of a sks painting"
python scripts/run_inference.py -m t2i -lp models/loras/wikiart/ace/Pointillism_paul-signac/lora_weight.safetensors -op outputs/wikiart/ace_t2i/Pointillism_paul-signac -spi 100 -p "a photo of a sks painting"
python scripts/run_inference.py -m t2i -lp models/loras/wikiart/ace/Post_Impressionism-van-gogh/lora_weight.safetensors -op outputs/wikiart/ace_t2i/Post_Impressionism-van-gogh -spi 100 -p "a photo of a sks painting"
python scripts/run_inference.py -m t2i -lp models/loras/wikiart/ace/Rococo_canaletto/lora_weight.safetensors -op outputs/wikiart/ace_t2i/Rococo_canaletto -spi 100 -p "a photo of a sks painting"

python scripts/run_inference.py -m i2i -ip data/outputs/wikiart/ace/Fauvism_henri-matisse -op outputs/wikiart/ace_i2i/Fauvism_henri-matisse -spi 1 -p "a photo of a sks painting"
python scripts/run_inference.py -m i2i -ip data/outputs/wikiart/ace/Impressionism_claude-monet -op outputs/wikiart/ace_i2i/Impressionism_claude-monet -spi 1 -p "a photo of a sks painting"
python scripts/run_inference.py -m i2i -ip data/outputs/wikiart/ace/Pointillism_paul-signac -op outputs/wikiart/ace_i2i/Pointillism_paul-signac -spi 1 -p "a photo of a sks painting"
python scripts/run_inference.py -m i2i -ip data/outputs/wikiart/ace/Post_Impressionism-van-gogh -op outputs/wikiart/ace_i2i/Post_Impressionism-van-gogh -spi 1 -p "a photo of a sks painting"
python scripts/run_inference.py -m i2i -ip data/outputs/wikiart/ace/Rococo_canaletto -op outputs/wikiart/ace_i2i/Rococo_canaletto -spi 1 -p "a photo of a sks painting"
