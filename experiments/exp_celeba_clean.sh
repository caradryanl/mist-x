...
python scripts/run_inference.py.py -m t2i -lp models/loras/celeba/clean/121/lora_weight.safetensors -op outputs/celeba/clean_t2i/121 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py.py -m t2i -lp models/loras/celeba/clean/1135/lora_weight.safetensors -op outputs/celeba/clean_t2i/1135 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py.py -m t2i -lp models/loras/celeba/clean/1422/lora_weight.safetensors -op outputs/celeba/clean_t2i/1422 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py.py -m t2i -lp models/loras/celeba/clean/1499/lora_weight.safetensors -op outputs/celeba/clean_t2i/1499 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py.py -m t2i -lp models/loras/celeba/clean/1657/lora_weight.safetensors -op outputs/celeba/clean_t2i/1657 -spi 100 -p "a photo of a sks person"

python scripts/run_inference.py.py -m i2i -ip data/outputs/celeba/clean/121 -op outputs/celeba/clean_i2i/121 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py.py -m i2i -ip data/outputs/celeba/clean/1135 -op outputs/celeba/clean_i2i/1135 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py.py -m i2i -ip data/outputs/celeba/clean/1422 -op outputs/celeba/clean_i2i/1422 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py.py -m i2i -ip data/outputs/celeba/clean/1499 -op outputs/celeba/clean_i2i/1499 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py.py -m i2i -ip data/outputs/celeba/clean/1657 -op outputs/celeba/clean_i2i/1657 -spi 1 -p "a photo of a sks person"
