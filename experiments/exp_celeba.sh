...
python scripts/run_inference.py -m t2i -lp models/loras/celeba/clean/121/pytorch_lora_weights.safetensors -op data/outputs/celeba/clean_t2i/121 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/clean/1135/pytorch_lora_weights.safetensors -op data/outputs/celeba/clean_t2i/1135 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/clean/1422/pytorch_lora_weights.safetensors -op data/outputs/celeba/clean_t2i/1422 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/clean/1499/pytorch_lora_weights.safetensors -op data/outputs/celeba/clean_t2i/1499 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/clean/1657/pytorch_lora_weights.safetensors -op data/outputs/celeba/clean_t2i/1657 -spi 100 -p "a photo of a sks person"

python scripts/run_inference.py -m i2i -ip data/celeba/121 -op data/outputs/celeba/clean_i2i/121 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/celeba/1135 -op data/outputs/celeba/clean_i2i/1135 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/celeba/1422 -op data/outputs/celeba/clean_i2i/1422 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/celeba/1499 -op data/outputs/celeba/clean_i2i/1499 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/celeba/1657 -op data/outputs/celeba/clean_i2i/1657 -spi 1 -p "a photo of a sks person"
...
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/121/pytorch_lora_weights.safetensors -op data/outputs/celeba/ace_t2i/121 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1135/pytorch_lora_weights.safetensors -op data/outputs/celeba/ace_t2i/1135 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1422/pytorch_lora_weights.safetensors -op data/outputs/celeba/ace_t2i/1422 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1499/pytorch_lora_weights.safetensors -op data/outputs/celeba/ace_t2i/1499 -spi 100 -p "a photo of a sks person"
python scripts/run_inference.py -m t2i -lp models/loras/celeba/ace/1657/pytorch_lora_weights.safetensors -op data/outputs/celeba/ace_t2i/1657 -spi 100 -p "a photo of a sks person"

python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/121 -op data/outputs/celeba/ace_i2i/121 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1135 -op data/outputs/celeba/ace_i2i/1135 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1422 -op data/outputs/celeba/ace_i2i/1422 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1499 -op data/outputs/celeba/ace_i2i/1499 -spi 1 -p "a photo of a sks person"
python scripts/run_inference.py -m i2i -ip data/outputs/celeba/ace/1657 -op data/outputs/celeba/ace_i2i/1657 -spi 1 -p "a photo of a sks person"
